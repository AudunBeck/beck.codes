...
## How does one stay in flow?
During a busy workday at companies that have a *startup mindset* one can easily get distracted by coworkers
coming in to check up on features, timelines, discuss a solution or just coming by to say hi. 

All of those reasons are important, but if you are in the middle of debugging a large feature and someone comes by or sends a message to asks who to ask about another feature, it will break your flow.
How could you make yourself a little *less* available, so people won't break your flow?

Add some friction:
- Wear noise cancelling headphones
- Put "do not disturb" on message apps
